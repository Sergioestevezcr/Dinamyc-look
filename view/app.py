...
from controller.auth_routes import auth_bp # Importamos el blueprint de autenticación
...
app.secret_key = 'mysecret_key' # Asegúrate de que esta sea una clave secreta fuerte en producción
